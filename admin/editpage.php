...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Pages</h1>
    <?php
    $id=$_GET['id'];
    ...
    $row=$res->fetch_assoc();
    ?>
  <form action="upd-page.php" method="post" >
  <input type="hidden" name="id" value="<?php echo $row['pid']; ?>">
                        <p>Page</p>
                        <p><input type="text" name="page" value="<?php echo $row['page']; ?>"></p>
                        
                        <p>Content</p>
                        <p><textarea name="content" ><?php echo $row['content']; ?></textarea></p>
