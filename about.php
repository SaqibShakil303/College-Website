...
$s="SELECT * FROM pages WHERE pid=4";
$rs=$con->query($s);
$row=$rs->fetch_assoc();
?>
...
<head>
    <title>Subject An Education Category Flat Bootstrap Responsive website Template | About :: w3layouts</title>
...
<?php include("inc/footer.php"); ?>
	<div class="copyright py-3">
		<div class="container">
			<div class="row">
				<div class="col-md-8">      
					<p class="copy-right mt-2">©Copyright © 2022 Syamaprasad Institute of Technology and Management(SITM). 
					</p>
				</div>
				<div class="col-md-4">
